...
class WildScanAnimationLoaderWidget extends StatelessWidget {
  /// Default constructor fo rthe TAnimationLoaderWidget.
  ///
  /// Parameters:
  ...
  const WildScanAnimationLoaderWidget({
    super.key,
    required this.text,
          ...
          showAction
              ? SizedBox(
                  ...
                  child: OutlinedButton(
                    ...
                    style:
                        OutlinedButton.styleFrom(backgroundColor: WildScanColors.dark),
                    child: Text(
                      actionText!,
                      style: Theme.of(context)
                          .textTheme
                          .bodyMedium!
                          .apply(color: WildScanColors.light),
                    ),
                  ),
                )
              : const SizedBox(),
